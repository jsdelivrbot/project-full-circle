initializeMap = function(){
  $(document).ready(function() {
    ...
    // $(legendDiv).css("margin-right", "1em");
    // $(legendDiv).css("padding", "5px");
    scrollButtonDiv.innerHTML = "<button id='scrollButton' style='background-color: #212121 !important; color: white; margin-bottom: 15px; height: 0.7em;' class='newsletter-form-button sqs-system-button sqs-editable-button-layout sqs-editable-button-style sqs-editable-button-shape'><strong>More good stuff&nbsp;</strong><img src='https://rawgit.com/Ravenstine/project-full-circle/staging/glyphicons-213-down-arrow-inverted.png' style='width: 10px;' draggable='false'/></button>";
